...
class ConcatenatedKNNProbingAccuracyMetric(GenericPluginMetric[float]):
    def __init__(self, 
                 train_stream, 
                 test_stream, 
                 k, 
        ...
        super(ConcatenatedKNNProbingAccuracyMetric, self).__init__(
