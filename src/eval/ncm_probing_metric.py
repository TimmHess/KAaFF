...
def compute_embeddings(loader, model, scaler, do_normalize=False): # TODO: indicate the "mean" property
    """
    Code adapted from: https://github.com/ivanpanshin/SupCon-Framework/blob/main/tools/losses.py
    """
    # NOTE: it's okay to do len(loader) * bs, since drop_last=True is enabled
...
class NCMProbingAccuracyMetric(GenericPluginMetric[float]):
    def __init__(self, 
                 train_stream, 
                 test_stream, 
                 k, 
        ...
        super(NCMProbingAccuracyMetric, self).__init__(
    ...
    def update(self, strategy=None):
        ...
        for k_i in self.k:
            ...
            #print("out", out, "y", y, "task_label", task_label)
